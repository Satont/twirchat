...
import type { Account, Platform, PlatformStatusInfo } from "@twirchat/shared";
...
onMounted(async () => {
    ...
    try {
        const saved = (await bindings.getChannels!()) as Partial<
        ...
        console.warn(
            "[PlatformsPanel] Failed to load persisted channels:",
            error,
        );
    }
});
...
async function joinChannel(platform: Platform) {
    ...
    try {
        ...
        console.error(
            `[PlatformsPanel] joinChannel failed for ${platform}:`,
            error,
        );
        addToast(
            platform,
        ...
        <div class="platforms-list">
            ...
            >
                ...
                <div class="card-header">
                    ...
                    <div class="card-title-area">
                        ...
                        <div class="card-status">
                            <span
                                class="status-dot"
                                :class="statusClass(status(platform))"
                            />
                ...
                <div class="card-channels">
                    ...
                    <div
                        v-if="platform === 'twitch' || !account(platform)"
                        class="channel-input-row"
                    >
                        ...
                        <button
                            class="btn btn-join"
                            :disabled="
                                !(channelInputs[platform] ?? '').trim() ||
                                joiningChannel[platform]
                            "
                    ...
                    >
                        <span class="auto-connected-text"
                            >Connected to your channel</span
                        >
                    </div>
                </div>
