...
import type { AppSettings, HotkeySettings } from "@twirchat/shared";
import { DEFAULT_SETTINGS } from "@twirchat/shared";
import {
    pause,
    resume,
    startKeyRecording,
...
const hotkeysConfig: Record<
    keyof HotkeySettings,
        ...
        <div class="settings-content">
            ...
            <section class="settings-section">
                ...
                <div class="form-row">
                    <div class="form-label">
                        ...
                        <span class="form-hint"
                            >Highlight messages mentioning you</span
                        >
                    </div>
                    <label class="switch">
                        <input
                            v-model="local.selfPing!.enabled"
                            type="checkbox"
                        />
                ...
                <div class="form-row form-row-preview">
                    <div class="form-label">
                        <span>Preview</span>
                        <span class="form-hint"
                            >How a pinged message looks</span
                        >
                    </div>
                    <div
                        class="ping-preview"
                        :style="
                            local.selfPing!.enabled
                                ? { background: local.selfPing!.color }
                                : {}
                        "
                    >
                        ...
                        <span class="ping-preview-text">
                            Hey
                            <span class="ping-preview-mention">@YourName</span>
                            what do you think?
                        </span>
                    </div>
                </div>
            ...
            <section class="settings-section">
                ...
                <div class="form-row">
                    ...
                    <label class="switch">
                        <input
                            v-model="local.autoCheckUpdates"
                            type="checkbox"
                        />
                        <span class="switch-thumb" />
                    </label>
            ...
            <section class="settings-section">
                ...
                <div class="form-row">
                    <div class="form-label">
                        ...
                        <span class="form-hint"
                            >Use "transparent" for chroma key</span
                        >
                    </div>
                    <div class="color-row">
                        <input
                ...
                <div class="form-row">
                    ...
                    <div class="color-row">
                        <input
                            v-model="local.overlay.textColor"
                            class="input-sm"
                        />
                        <input
                            v-model="local.overlay.textColor"
                ...
                <div class="form-row">
                    ...
                    <div class="slider-row">
                        ...
                        <span class="slider-val"
                            >{{ local.overlay.fontSize }}px</span
                        >
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="toggle-group">
                        <button
                            ...
                            class="toggle-btn"
                            :class="{
                                active: local.overlay.animation === anim,
                            }"
                            @click="
                                local.overlay.animation =
                                    anim as AppSettings['overlay']['animation']
                            "
                        >
                            {{ anim }}
                        </button>
                ...
                <div class="form-row">
                    ...
                    <div class="toggle-group">
                        <button
                            ...
                            @click="
                                local.overlay.position =
                                    pos as AppSettings['overlay']['position']
                            "
                        >
                            {{ pos }}
                        </button>
                ...
                <div class="form-row">
                    ...
                    <label class="switch">
                        <input
                            v-model="local.overlay.showPlatformIcon"
                            type="checkbox"
                        />
                        <span class="switch-thumb" />
                    </label>
                ...
                <div class="form-row">
                    ...
                    <label class="switch">
                        <input
                            v-model="local.overlay.showAvatar"
                            type="checkbox"
                        />
                        <span class="switch-thumb" />
                    </label>
            ...
            <section class="settings-section">
                ...
                <div
                    v-for="(config, key) in hotkeysConfig"
                    :key="key"
                    class="form-row"
                >
                    <div class="form-label">
                    ...
                    >
                        <template v-if="recordingAction === key"
                            >Press a key…</template
                        >
                        <template v-else>
                            <kbd>{{
                                formatKeyCombo(
                                    local.hotkeys[key as keyof HotkeySettings],
                                )
                            }}</kbd>
                        </template>
                    </button>
