...
<template>
  <article class="history-message">
    <span class="history-message-stripe" :style="{ background: platformColor(message.platform) }" />

    <div class="history-message-main">
      <div class="history-message-meta">
        <span class="history-message-time">{{ formatTimestamp(message.timestamp) }}</span>
        <span class="history-message-channel">{{ message.channelId }}</span>
        <span class="history-message-type" :class="`type-${message.type}`">{{ message.type }}</span>
      </div>
