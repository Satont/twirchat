/**
 * Icon set for the GPUIX app.
 *
 * GPUIX `<svg>` is a monochrome renderer tinted via `style.color`, and
 * `currentColor` inside the SVG source does NOT resolve — so every source
 * here uses explicit `#000` for fill/stroke and gets tinted by the caller.
 *
 * Sources were ported from the Vue app's inline SVGs (lucide-style 24×24,
 * stroke-width 2) and src/assets/icons.
 */
...
export const icons = {
  // ── App shell (from App.vue) ────────────────────────────────────────────
  logo: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"><rect x="2" y="3" width="20" height="14" rx="3" fill="#000" opacity=".9" /><path d="M7 21h10M12 17v4" stroke="#000" stroke-width="2" stroke-linecap="round" /></svg>`,
  ...
  chevronRight: stroke('<polyline points="9 18 15 12 9 6" />'),
  ...
  reply: stroke('<polyline points="9 17 4 12 9 7" /><path d="M20 18v-2a4 4 0 0 0-4-4H4" />'),
  copy: stroke(
  ...
  pencil: stroke('<path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z" />'),
  edit: stroke(
  ...
  sparkle: fill('<path d="M12 2l2.4 7.2L22 12l-7.6 2.8L12 22l-2.4-7.2L2 12l7.6-2.8z" />'),

  // ── Events feed (inline SVGs from EventsFeed.vue) ───────────────────────
  heart: stroke(
  ...
  playCircle: stroke('<circle cx="12" cy="12" r="10" /><polygon points="10 8 16 12 10 16 10 8" />'),
  dollar: stroke(
    '<line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />',
  ),

  // ── Platform logos (monochrome paths tinted with the platform color) ────
  twitch: fill(
...
export const platformIconNames: Record<string, IconName> = {
  twitch: 'twitch',
  youtube: 'youtube',
  kick: 'kick',
}
